...
$url64         = 'https://github.com/github/copilot-cli/releases/download/v1.0.71/copilot-win32-x64.zip'
$checksum64    = 'e4642b2efce3649c49849fde30307242f9a2475133533294a55b881187818471'
