...
|---------|---------|-------------|
| **foldersync-desktop** | [![Chocolatey Version](https://img.shields.io/badge/Chocolatey-2.9.3-green)](https://chocolatey.org/packages/foldersync-desktop) | Desktop file synchronization tool |
| **github-copilot-cli** | [![Chocolatey Version](https://img.shields.io/badge/Chocolatey-1.0.65-green)](https://chocolatey.org/packages/github-copilot-cli) | GitHub Copilot command-line interface |
